...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  async function createCompany() {
    ...
    if (body?.Renamedfunction?.length > 0) {
      const create_Renamedfunction = body.Renamedfunction;
      body.Renamedfunction = {
        create: create_Renamedfunction,
      };
    } else {
      delete body.Renamedfunction;
    }

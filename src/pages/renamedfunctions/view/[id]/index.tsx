...
import { getRenamedfunctionById } from 'apiSdk/renamedfunctions';
...
function RenamedfunctionViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Renamedfunction Detail View
          </Text>
          {hasAccess('renamedfunction', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/renamedfunctions/edit/${data?.id}`} passHref legacyBehavior>
              <Button

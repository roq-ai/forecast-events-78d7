...
import { createRenamedfunction } from 'apiSdk/renamedfunctions';
...
function RenamedfunctionCreatePage() {
  ...
  const handleSubmit = async (values: RenamedfunctionInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createRenamedfunction(values);
      resetForm();
